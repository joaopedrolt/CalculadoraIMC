    ...
    <div className='row jc-center h-100'>
      <div className={legendBColor + " legend-result h-100 d-flex al-center jc-center column"}>
        <div className='d-flex al-center'>
          <div className='return-button d-flex al-center jc-center'><img className='left-arrow' src={leftArrow} /></div>
          <div className='d-flex al-center column info'>
            ...
            <p className='c-white mt-8 fz-20'>O seu IMC está entre {result}</p>
          </div>
        </div>
      </div>
    </div>
